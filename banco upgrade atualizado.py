...
def depositar(saldo, valor, extrato, /):
    """
    Deposit the given value into the account and update the extrato.
    """
    if valor > 0:
        saldo += valor
...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    """
    Withdraw the given value from the account and update the extrato.
    """
...
def filtrar_usuario(cpf, usuarios):
    """
Filter the users list by the given CPF and return the user if found.
    """
